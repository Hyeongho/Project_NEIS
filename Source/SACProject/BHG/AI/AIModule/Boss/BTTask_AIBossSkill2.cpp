...
#include "BTTask_AIBossSkill2.h"
#include "../../AI_BossMonster.h"
#include "../../../Animation/BHG_AIBossAnimInstance.h"

UBTTask_AIBossSkill2::UBTTask_AIBossSkill2() :
	Super()
{
	NodeName = TEXT("BossSkill2");
	bNotifyTick = true;

	bNotifyTaskFinished = true;
}

EBTNodeResult::Type UBTTask_AIBossSkill2::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	AIBossMonster->BossSKill2();

	return EBTNodeResult::InProgress;
}

EBTNodeResult::Type UBTTask_AIBossSkill2::AbortTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
void UBTTask_AIBossSkill2::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
...
void UBTTask_AIBossSkill2::OnTaskFinished(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, EBTNodeResult::Type TaskResult)
{
