...
#include "BTTask_AuroraFreeze.h"
#include "../AuroraAICharacter.h"
#include "../AuroraAIAnimInstance.h"
#include "../../AIState.h"

UBTTask_AuroraFreeze::UBTTask_AuroraFreeze()
{
    NodeName = TEXT("AuroraFreeze");
...
EBTNodeResult::Type UBTTask_AuroraFreeze::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
EBTNodeResult::Type UBTTask_AuroraFreeze::AbortTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
    Super::ExecuteTask(OwnerComp, NodeMemory);
...
void UBTTask_AuroraFreeze::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
...
void UBTTask_AuroraFreeze::OnTaskFinished(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, EBTNodeResult::Type TaskResult)
{
