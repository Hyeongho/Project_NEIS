...
#include "BTTask_AuroraDash.h"
#include "../AuroraAICharacter.h"
#include "../AuroraAIAnimInstance.h"
#include "../../AIState.h"


UBTTask_AuroraDash::UBTTask_AuroraDash()
{
	NodeName = TEXT("AuroraDash");
...
EBTNodeResult::Type UBTTask_AuroraDash::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
EBTNodeResult::Type UBTTask_AuroraDash::AbortTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
void UBTTask_AuroraDash::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
...
void UBTTask_AuroraDash::OnTaskFinished(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, EBTNodeResult::Type TaskResult)
{
